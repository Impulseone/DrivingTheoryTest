...
class CustomTextStyle {
  ...
  static TextStyle engTextStyleBodyBlack(BuildContext context) {
    return Theme.of(context).textTheme.bodyText1.copyWith(fontSize: 16.0, fontWeight: FontWeight.bold, color: Colors.black);
  }
  static TextStyle rusTextStyleBodyBlack(BuildContext context) {
    return Theme.of(context).textTheme.bodyText1.copyWith(fontSize: 12.0, color: Colors.black);
  }
}